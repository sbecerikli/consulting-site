<x-app-layout>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900 mb-6">{{ $aboutContent->company_story_title }}</h2>
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        {{ $aboutContent->company_story_content_1 }}
                    </p>
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        {{ $aboutContent->company_story_content_2 }}
                    </p>
                    <div class="grid grid-cols-2 gap-6 mt-8">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-gray-600">Uzmanlık Alanı</div>
                        </div>
                    </div>
                </div>
                <div class="relative">
                    <div class="bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl p-8 text-white">
                        <div class="text-center">
                            ...
                            <h3 class="text-2xl font-bold mb-4">{{ $aboutContent->mission_title }}</h3>
    ...
    <div class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ $aboutContent->values_title }}</h2>
                <p class="text-lg text-gray-600">{{ $aboutContent->values_subtitle }}</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $aboutContent->value_1_title }}</h3>
                    <p class="text-gray-600">{{ $aboutContent->value_1_content }}</p>
                </div>
                <div class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $aboutContent->value_2_title }}</h3>
                    <p class="text-gray-600">{{ $aboutContent->value_2_content }}</p>
                </div>
                <div class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">{{ $aboutContent->value_3_title }}</h3>
                    <p class="text-gray-600">{{ $aboutContent->value_3_content }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ $aboutContent->team_title }}</h2>
                <p class="text-lg text-gray-600">{{ $aboutContent->team_subtitle }}</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-lg p-6 text-center hover:shadow-lg transition duration-300">
                    ...
                    <p class="text-gray-600 mb-4">{{ Str::limit($member->bio, 120) }}</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg p-6 hover:shadow-lg transition duration-300">
                    ...
                    <p class="text-gray-600 mb-4">{{ Str::limit($service->excerpt, 100) }}</p>
